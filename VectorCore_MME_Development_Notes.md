...
| ----------------- | -------------------- | -------------------------------------------------------------------------- | ------------------------------------ | -------------------------------------------------------------------------------- | ------------ |
| **S1-MME / S1AP** | eNodeB               | LTE access signaling                                                       | Implemented                          | Add configurable QoS/DSCP marking; continue interoperability testing             | Immediate    |
| **S6a**           | HSS                  | Subscriber authentication, location management, and subscription retrieval | Implemented                          | Add configurable QoS/DSCP marking; improve peer resiliency and overload handling | Immediate    |
| **S10**           | MME                  | MME-to-MME context transfer and mobility                                   | Implemented or partially implemented | Complete interoperability, relocation, restart, and failure testing              | Immediate    |
| **S11**           | SGW-C                | Session and bearer control using GTPv2-C                                   | Implemented                          | Add configurable QoS/DSCP marking; continue paging and recovery validation       | Immediate    |
| **S13**           | EIR                  | Equipment identity checking                                                | Not implemented                      | Plan Diameter application, EIR policies, FSMs, and failure handling              | Medium       |
| **SBc-AP**        | CBC                  | Public Warning System signaling                                            | Not implemented                      | Plan protocol, warning-area handling, message lifecycle, and FSMs                | Low          |
| **SGsAP**         | MSC/VLR              | CS fallback and SMS over SGs                                               | Not implemented                      | Research protocol, mobility state, SMS handling, and FSMs                        | Low          |
| **SGd**           | SMS-GMSC / SMS-IWMSC | SMS delivery using Diameter                                                | Not implemented                      | Required for SMS in MME; research routing and transaction handling               | Low          |
...
| **SLg**           | GMLC                 | EPC Location Services signaling                                            | Not implemented                      | Plan Diameter application, authorization, and location-request procedures        | Low          |
| **SLs**           | E-SMLC               | UE positioning and location procedures                                     | Not implemented                      | Plan protocol, positioning sessions, and E-SMLC interaction                      | Low          |
| **Sv**            | MSC Server           | Single Radio Voice Call Continuity                                         | Not implemented                      | Plan only if LTE-to-2G/3G voice handover is required                             | Very Low     |
| **Sm**            | MBMS-GW              | MBMS session-control signaling                                             | Not implemented                      | Future MBMS session-start, stop, and service-area support                        | Very Low     |
| **S102**          | 3GPP2 1xCS IWS       | CDMA2000 circuit-switched fallback interworking                            | Out of scope                         | Implement only if CDMA2000 interworking is explicitly required                   | Out of Scope |
