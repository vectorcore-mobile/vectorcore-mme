...
| ----------------- | -------------------- | -------------------------------------------------------------------------- | ------------------------------------ | -------------------------------------------------------------------------------- | ------------ |
| **S1-MME / S1AP** | eNodeB               | LTE access signaling                                                       | Implemented                          | Add configurable QoS/DSCP marking; continue interoperability testing             | N/A          |
| **S6a**           | HSS                  | Subscriber authentication, location management, and subscription retrieval | Implemented                          | Add configurable QoS/DSCP marking; improve peer resiliency and overload handling | N/A          |
...
| **S11**           | SGW-C                | Session and bearer control using GTPv2-C                                   | Implemented                          | Add configurable QoS/DSCP marking; continue paging and recovery validation       | N/A          |
| **S13**           | EIR                  | Equipment identity checking                                                | Implemented                          | Completed  								          | N/A          |
| **SBc-AP**        | CBC                  | Public Warning System signaling                                            | Not implemented                      | Plan protocol, warning-area handling, message lifecycle, and FSMs                | High         |
