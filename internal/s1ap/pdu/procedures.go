...
const (
	...
	ProcNASNonDeliveryIndication      uint8 = 14
	ProcReset                         uint8 = 15
	ProcErrorIndication               uint8 = 16
...
const (
	...
	IEERABSetupListBearerSURes        uint16 = 9
	IEERABToBeSetupListBearerSUReq    uint16 = 10
	IEERABFailedToSetupListBearerSURes uint16 = 11
	IEERABToBeModifiedListBearerModReq uint16 = 13
	IEERABFailedToModifyList          uint16 = 14
	IEERABToBeReleasedList            uint16 = 15
	IEERABFailedToReleaseList         uint16 = 16
	IEERABReleaseListERABRelComp      uint16 = 18
	...
	IEERABFailedToSetupListCtxtSURes  uint16 = 28
	...
	IEERABAdmittedList                   uint16 = 18  // HandoverRequestAck: admitted list (same value as IEERABReleaseListERABRelComp)
