...
var Phase1Procedures = []ProcedureInfo{
	...
	{Name: "DownlinkUEAssociatedLPPaTransport", PDUType: PDUTypeInitiatingMessage, Code: ProcDownlinkUEAssociatedLPPaTransport, Direction: DirectionMMEToENB},
	{Name: "UplinkUEAssociatedLPPaTransport", PDUType: PDUTypeInitiatingMessage, Code: ProcUplinkUEAssociatedLPPaTransport, Direction: DirectionENBToMME},
}

var Phase1ProcedureIEs = map[ProcedureIEKey]IEInfo{
	{ProcDownlinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IEMMEUES1APID}: {"MME-UE-S1AP-ID", IEMMEUES1APID, aper.CriticalityReject, IEPresenceMandatory, "MME-UE-S1AP-ID"},
	{ProcDownlinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IEENBS1APID}:   {"eNB-UE-S1AP-ID", IEENBS1APID, aper.CriticalityReject, IEPresenceMandatory, "ENB-UE-S1AP-ID"},
	{ProcDownlinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IERoutingID}:   {"Routing-ID", IERoutingID, aper.CriticalityReject, IEPresenceMandatory, "Routing-ID"},
	{ProcDownlinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IELPPaPDU}:     {"LPPa-PDU", IELPPaPDU, aper.CriticalityReject, IEPresenceMandatory, "LPPa-PDU"},
	{ProcUplinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IEMMEUES1APID}:   {"MME-UE-S1AP-ID", IEMMEUES1APID, aper.CriticalityReject, IEPresenceMandatory, "MME-UE-S1AP-ID"},
	{ProcUplinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IEENBS1APID}:     {"eNB-UE-S1AP-ID", IEENBS1APID, aper.CriticalityReject, IEPresenceMandatory, "eNB-UE-S1AP-ID"},
	{ProcUplinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IERoutingID}:     {"Routing-ID", IERoutingID, aper.CriticalityReject, IEPresenceMandatory, "Routing-ID"},
	{ProcUplinkUEAssociatedLPPaTransport, PDUTypeInitiatingMessage, IELPPaPDU}:       {"LPPa-PDU", IELPPaPDU, aper.CriticalityReject, IEPresenceMandatory, "LPPa-PDU"},
...
var Phase1ProcedureIEOrder = map[ProcedureIEKey][]uint16{
	{ProcedureCode: ProcDownlinkUEAssociatedLPPaTransport, PDUType: PDUTypeInitiatingMessage}: {IEMMEUES1APID, IEENBS1APID, IERoutingID, IELPPaPDU},
	{ProcedureCode: ProcUplinkUEAssociatedLPPaTransport, PDUType: PDUTypeInitiatingMessage}:   {IEMMEUES1APID, IEENBS1APID, IERoutingID, IELPPaPDU},
